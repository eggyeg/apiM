...
const CANNOT = new Map([
  ...
  ["build_project", "covered by test-build on synthetic projects; no real toolchain is installed here"],
  ...
  ["note_binary", "covered by test-binaries, which owns the binary-ledger fixtures"],
  ["note_finding", "covered by test-findings against the durable store"],
