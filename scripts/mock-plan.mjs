...
createServer((req,res)=>{
  ...
  req.on("end",()=>{
    ...
    if (n===1) call("c1","make_plan",{goal:"Do the thing",steps:["Step one","Step two","Step three"]});
    else if (n===2) call("c2","update_plan",{updates:[{id:1,state:"done",verified:"checked it"}]});
    else if (n===3) {
    ...
    else if (n===4) call("c4","update_plan",{updates:[{id:2,state:"done",verified:"ok"},{id:3,state:"done",verified:"ok"}]});
